    ...
    <div class="container_section">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h1 style="margin-top: 5px;font-family: 'Neuton', serif;font-size: 55px; ">Our Victories</h1>
                <p style="text-align: justify; font-style: normal; font-family: 'Neuton', helvetica, serif">
