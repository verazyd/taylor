...
<div class="practice_areas_section">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <p>The passing of land and property interests should be the simple culmination of the hard work that had allowed you to
                reach that stage of action. We here at Taylor & Preston Lawyers work hard so that you do not have to. Our tailored service
                and competitive fees ensures that your conveyance is in safe, trusted and competent hands.
            </p>
            <p>
                If you would like to speak to someone in relation to Property Contamination matter, please call on <b>1800 633 625 between 7A.M.and 11P.M. Monday to Sunday</b>.
            </p>
        </div>
        <div class="col-md-12">
            <h2>Work Injury</h2>
        ...
        <div class="col-md-12">
            <h2>Sexual & Institutional Abuse</h2>
        ...
        <div class="col-md-12">
            <h2>International and Chinese Law</h2>
            <p>Taylor & Preston Lawyers practice in International and Chinese Law and accept matters in Victoria</p>
            <p>If you would like to speak to someone in relation to an international law matter, or contact our China team, please call our new client services team on 1800 633 625. between 7A.M.and 11P.M. Monday to Sunday.</p>
            <p><a href="{{ URL::route('legalteam') }}">Contact Payne Wu </a>to talk more in details. OR View<a href="{{ URL::route('legalteam') }}">Our Legal Team</a> for more details. </p>
        </div>
        <div class="col-md-12">
            <h2>Wills & Estates</h2>
            <p>Taylor & Preston Lawyers practice in Wills & Estates Law and accept matters in Victoria</p>
            <p>If you would like to speak to someone in relation to an international law matter, or contact our team, please call our new client services team on 1800 633 625. between 7A.M.and 11P.M. Monday to Sunday.</p>
            <p> View<a href="{{ URL::route('legalteam') }}">Our Legal Team</a> for more details. </p>
        </div>
    </div>
@stop