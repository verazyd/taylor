...
Route::get('Category.html/{id}',['as' => 'category', 'uses' =>'TagsController@show']);
...
Route::get('Blog.html/{id}',['as' => 'blog' , 'uses' => 'BlogsController@show']);
...
#lawyers
Route::get('Jeremy.html', ['as' => 'jeremy', 'uses' =>'PagesController@lawyer_jeremy']);
Route::get('Madline.html', ['as' => 'madeline', 'uses' =>'PagesController@lawyer_madeline']);
Route::get('Holly.html', ['as' => 'holly', 'uses' =>'PagesController@lawyer_holly']);
Route::get('Payne-Wu.html', ['as' => 'wu', 'uses' =>'PagesController@lawyer_wu']);
Route::get('Peter.html', ['as' => 'peter', 'uses' =>'PagesController@lawyer_peter']);
Route::get('Paul.html', ['as' => 'paul', 'uses' =>'PagesController@lawyer_paul']);
Route::get('Legal-Services.html', ['as' => 'legal_services', 'uses' =>'PagesController@legal_services']);
Route::get('Keywords.html', ['as' => 'keywords', 'uses' =>'PagesController@keywords']);